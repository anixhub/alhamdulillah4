...
app.post("/api/upload", async (req, res) => {
  try {
    ...
    const dirsToSave = [
      import_path.default.join(uploadBase, subFolder),
...
app.get("/api/uploads/:category/:fileName", (req, res) => {
  try {
    ...
    const rootDir = getPersistentRootDir();
    const possiblePaths = [
      import_path.default.join(uploadBase, safeCategory, safeFileName),
      import_path.default.join(uploadBase, safeFileName),
